...
export default function UserNReview() {
    return (
        <div className=''>
            <div>
                <h3 className='text-2xl font-bold text-accent'>Users And Review Management</h3>
            </div>
            <div className="grid lg:grid-cols-5 gap-6 mt-8">
                ...
                {/* Placeholder Card */}
                <div className="group bg-[#f9f9f9] border border-gray-200 rounded-lg shadow-md p-5 flex flex-col items-center space-y-4 transition-transform duration-300 hover:scale-105 hover:shadow-xl h-full">
                    <h2 className="text-lg font-semibold text-gray-700 text-center group-hover:text-green-600">
                        Lorem Ipsum
                    </h2>
                </div>
            </div>
