            ...
            <div className='grid lg:grid-cols-5 gap-4 mt-5'>
                <Link href='/admin-dashboard/all-orders'>
                    <div className='border hover:border-none md:w-40 flex flex-col items-center p-3 bg-white space-y-2 hover:shadow border-primary rounded-md shadow-2xl lg:transition lg:hover:scale-105 group h-full'>
                        <Image src='/assets/order-list.png' alt='add-product' height='50' width='50' />
                        <div>
                            <h2 className='text-xl group-hover:text-accent duration-300 text-center'>All Orders</h2>
                        </div>
                    </div>
                </Link>
                <Link href='/admin-dashboard/manage-orders'>
                    <div className='border hover:border-none md:w-40 flex flex-col items-center p-3 bg-white space-y-2 hover:shadow border-primary rounded-md shadow-2xl lg:transition lg:hover:scale-105 group h-full'>
                        ...
                        <div>
                            <h2 className='text-xl group-hover:text-accent duration-300 text-center'>Manage Orders</h2>
                        </div>
                    </div>
                </Link>
                <Link href='/admin-dashboard/archived-orders'>
                    <div className='border hover:border-none md:w-40 flex flex-col items-center p-3 bg-white space-y-2 hover:shadow border-primary rounded-md shadow-2xl lg:transition lg:hover:scale-105 group h-full'>
                        ...
                        <div>
                            <h2 className='text-xl group-hover:text-accent duration-300 text-center'>Archived Orders</h2>
                        </div>
                    </div>
                </Link>
            </div>
