        ...
        <section>
            <div className="flex justify-between gap-3 flex-col md:gap-2">
                <button
                    ...
                    className="flex items-center justify-center gap-2 border border-gray-800 rounded-md bg-white font-semibold px-2 py-2 hover:bg-primary hover:text-white dark:text-black duration-700"
                >
