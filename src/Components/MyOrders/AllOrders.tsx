...
import { useAllProductsUser } from "@/app/my-orders/api/route";
...
const AllOrders = () => {
    ...
    const { data: items = [], isLoading, isError, error } = useAllProductsUser(uuid as string);
            ...
            {items?.map((order) => (
                ...
                >
                    <div className="flex flex-wrap justify-between items-center">
                        ...
                        <h5 className="bg-primary p-2 rounded-full text-white dark:text-white text-xs">
                            {order.order_status}
                        </h5>
                    </div>
